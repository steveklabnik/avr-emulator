	...
	var EmulatorProvider = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      { store: store },
	      function () {
	        return React.createElement(_containersEmulatorApp2['default'], null);
	      }
	    );
	  }
	});

	React.render(React.createElement(EmulatorProvider, null), document.getElementById('emulator'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsCombineReducers = __webpack_require__(10);

	var _utilsCombineReducers2 = _interopRequireDefault(_utilsCombineReducers);

	var _utilsBindActionCreators = __webpack_require__(2);
	...
	var _utilsComposeMiddleware = __webpack_require__(13);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _composeMiddleware = __webpack_require__(13);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsCreateAll = __webpack_require__(170);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createProvider = __webpack_require__(171);
	...
	var _createConnectDecorator = __webpack_require__(179);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsCreateStoreShape = __webpack_require__(172);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsShallowEqualScalar = __webpack_require__(180);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EmulatorApp = (function () {
	  function EmulatorApp() {
	    _classCallCheck(this, EmulatorApp);
	  }

	  _createClass(EmulatorApp, [{
	    key: 'render',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var IOStore = (function () {
	  function IOStore() {
	    _classCallCheck(this, IOStore);
	  }

	  _createClass(IOStore, [{
	    key: 'render',
	    value: function render() {
...
/***/ function(module, exports) {
	...
	exports.padInteger = padInteger;

	function formatBinary(integer) {
	...
	function padInteger(integer) {
	  var padCharacter = arguments.length <= 1 || arguments[1] === undefined ? "0" : arguments[1];
	  var length = arguments.length <= 2 || arguments[2] === undefined ? 2 : arguments[2];
	  var base = arguments.length <= 3 || arguments[3] === undefined ? 16 : arguments[3];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RegisterState = (function () {
	  function RegisterState() {
	    _classCallCheck(this, RegisterState);
	  }

	  _createClass(RegisterState, [{
	    key: 'render',
	    value: function render() {
	...
	RegisterState.propTypes = {
	  registers: _react2['default'].PropTypes.arrayOf(_react2['default'].PropTypes.number).isRequired
	};
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DebuggerButtons = (function () {
	  ...
	  return DebuggerButtons;
	})();

	exports['default'] = DebuggerButtons;
...
/***/ function(module, exports, __webpack_require__) {
	...
	RegisterState.propTypes = {
	  instructions: _react2['default'].PropTypes.arrayOf(_react2['default'].PropTypes.string).isRequired,
	  programPointer: _react2['default'].PropTypes.number.isRequired
	};
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WEBSOCKET_UPDATE = 'websocketUpdate';

	exports.WEBSOCKET_UPDATE = WEBSOCKET_UPDATE;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var socket = new WebSocket("ws://72.2.118.178:8000", "rust-websocket");

	exports.socket = socket;

	function initializeSocketListener(store) {
	  socket.onmessage = function (event) {
	    store.dispatch({
	      type: _actionsDebuggerActions.WEBSOCKET_UPDATE,
	      event: event
	    });
	  };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function emulator(state, action) {
	  if (state === undefined) state = initialState;

	  switch (action.type) {
	    case _actionsDebuggerActions.WEBSOCKET_UPDATE:
...
/***/ function(module, exports, __webpack_require__) {
	...
	function websocketMiddleware(_ref) {
	  ...
	  return function (next) {
	    return function (action) {
	      var socketMessageName = action.socketMessageName;
	      ...
	      var socketMessage = action.socketMessage;

	      var rest = _objectWithoutProperties(action, ['socketMessageName', 'socketMessage']);

	      if (!socketMessageName) {
	        return next(action);
	      }

	      _initializersWebsocket.socket.send(socketMessage.programInstructions);
	    };
	  };
	}
